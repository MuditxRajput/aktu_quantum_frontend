...
const PdfArea = () => {
  ...
  const hitApi = async () => {
    try {
      const response = await fetch(`https://quantum-backend-1.onrender.com/admin/numberOfPdf`, {
        method: "GET",
      });
  ...
  return (
    <div>
    <p className="flex justify-center text-orange-600 font-semibold text-xl">Click on pdf to get..</p>
      {userInfo ? (
