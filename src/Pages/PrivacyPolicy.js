  ...
  return (
    <div className="container px-10 py-8">
      <div className="bg-white rounded-lg shadow-md p-10 ">
        ...
        <br></br>
        <h4 className="font-semiold text-lg ">Tracking Technologies and Cookies</h4>
        <p>
        ...
        <h3 className="font-semibold text-lg">Retention of Your Personal Data</h3>
        <p>
        ...
        <br></br>
        <ul className="list-disc">
          <li>Comply with a legal obligation</li><br></br>
          <li>Protect and defend the rights or property of the Company</li><br></br>
          <li>
          ...
          <li>Protect against legal liability</li><br></br>
        </ul>
