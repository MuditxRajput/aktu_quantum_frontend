...
const LoginPage = () => {
  ...
  const onSubmitData=async(e)=>{
    ...
    e.preventDefault();
    try {
      const response = await fetch(`https://quantum-backend-1.onrender.com/user/login`,
      {
        method:"POST",
        headers:{
  ...
  return (
    ...
    <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="mt-2 text-center text-sm text-gray-600 max-w">
            Or
            <p className="font-medium text-blue-600 hover:text-blue-500 cursor-pointer" onClick={()=>{navigate('/register')}}>
                create an account
            </p>
        </div>
    </div>
